...
class RGI(RGIBase):
    ...
    def __init__(self, input_type='contig', input_sequence=None, threads=32, output_file=None, loose=False,
                 clean=True, data='na', aligner='blast', galaxy=None, local_database=False, low_quality=False, debug=False, include_nudge=False, keep=False, orf_finder='prodigal'):
    ...
    def process_contig(self):
        ...
        orf_obj = orf_finder_cls(input_file=self.input_sequence, threads=self.threads, clean=self.clean,
